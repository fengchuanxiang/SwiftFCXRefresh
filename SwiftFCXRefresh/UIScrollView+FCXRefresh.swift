...
extension UIScrollView {
    @discardableResult
    func addFCXRefreshHeader(handler: @escaping (FCXRefreshBaseView) -> Void) -> FCXRefreshHeaderView {
    ...
    @discardableResult
    func addFCXRefreshFooter(handler: @escaping (FCXRefreshBaseView) -> Void) -> FCXRefreshFooterView {
    ...
    @discardableResult
    func addFCXRefreshAutoFooter(handler: @escaping (FCXRefreshBaseView) -> Void) -> FCXRefreshFooterView {
