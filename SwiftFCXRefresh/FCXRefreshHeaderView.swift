...
open class FCXRefreshHeaderView: FCXRefreshBaseView {
    ...
    let arrowImageView = UIImageView.init(image: UIImage.init(named: "arrow"))
    ...
    public override func fcxRefreshStateNormal() {
        statusLabel.text = normalText
    ...
    public override func fcxRefreshViewStatePulling() {
    ...
    public override func fcxRefreshViewStateLoading() {
    ...
    public override func fcxRefreshBaseViewUpdateRefreshDate() {
        dateLabel.text = currentDateString()
    }
